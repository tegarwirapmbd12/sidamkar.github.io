...
<head>
    ...
    <!--title-->
    <title>Domain Search Result - Hosting Provider with WHMCS Template</title>
...
<body>
        ...
        <div id="logoAndNav" class="main-header-menu-wrap white-bg border-bottom">
            <div class="container">
                <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                    ...
                    <!--logo start-->
                    <a class="navbar-brand" href="index.html"><img src="assets/img/logo-color.png" width="120" alt="logo"
                                                                   class="img-fluid"/></a>
                    <!--logo end-->
                                            ...
                                            <div class="row mega-menu-wrap">
                                                ...
                                                <div class="col-md-6">
                                                    <ul class="sub-menu-nav-group mb-3">
                                                        ...
                                                        <li><a class="nav-link sub-menu-nav-link"
                                                               href="index-reseller-hosting.html">Reseller Demo <span class="badge badge-success ml-2">New</span></a></li>
                                                    </ul>
    
                                                    <span class="sub-menu-title">RTL Demo</span>
                                                    <ul class="sub-menu-nav-group mb-3">
                                                        <li><a class="nav-link sub-menu-nav-link"
                                                               href="http://hostlar.themetags.com/template-rtl/index.html">Home Default Arabic <span class="badge badge-danger ml-2">RTL</span></a></li>
                                                    </ul>
                                ...
                                <ul id="pagesSubMenu" class="hs-sub-menu main-sub-menu" aria-labelledby="pagesMegaMenu"
                                    ...
                                    <li class="hs-has-sub-menu">
                                        ...
                                        <ul id="navSubmenuPagesPricing" class="hs-sub-menu main-sub-menu"
                                            ...
                                            <li><a class="nav-link sub-menu-nav-link"
                                                   href="pricing-new.html">New Pricing <span class="badge badge-success ml-2">New</span></a></li>
                                        </ul>
                                    </li>
                                    <li class="hs-has-sub-menu">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <ul class="sub-menu-nav-group">
                                                    ...
                                                    <li><a class="nav-link sub-menu-nav-link"
                                                           href="tabs.html">Tab</a></li>
                                                    <li><a class="nav-link sub-menu-nav-link"
                                                           href="videos.html">Videos</a></li>
                                                    <li><a class="nav-link sub-menu-nav-link"
                                                           href="forms.html">Form</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="main">
        ...
        <section class="hero-equal-height pt-165 ptb-100 gradient-overly-right" style="background: url('assets/img/hero-1.jpg')no-repeat center center / cover">
            <div class="container">
                        ...
                        <div class="hero-content-left text-white text-center">
                            ...
                            <form action="" class="domain-search-form mt-3 w-75  mx-auto">
                                <div class="input-group">
                                    <input type="text" name="domain" id="domain" value="<?php echo (isset($_GET['domain']) ? $_GET['domain'] : ''); ?>" class="form-control" placeholder="example.com" required="">
                    ...
                    <div class="col-lg-3">
                        <div class="domain-extension-filter-wrap p-4 white-bg rounded">
                            ...
                            <ul class="list-unstyled domain-filter-list mt-3">
                                ...
                                <button type="submit" class="btn btn-block outline-btn mt-3">Apply</button>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="content-with-sidebar">
                            ...
                            <table class="table vps-hosting-pricing-table domain-search-result-table alert-table mb-5">
                                ...
                                <tr class="vps-pricing-row border-accent-primary">
                                    <td>Domain <span class="color-primary"><?php echo $_GET['domain'] ? $_GET['domain'] : 'example.com'; ?></span> is available!
                                    ...
                                    <td>
                                        <a href="http://whmcs.themetags.com/cart.php?a=add&domain=register&query=<?php echo $_GET['domain']; ?>" class="btn secondary-solid-btn">Add to Cart</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="row">
                                <div class="col-12 pb-3">
                                    <div class="alert alert-danger">Domain(<?php echo $_GET['domain']; ?>) is not available. </div>
                                </div>
                            </div>
                            <?php } ?>
                            <!--alert table end-->
                            ...
                            <table class="table vps-hosting-pricing-table domain-search-result-table">
                                ...
                                <tr class="vps-pricing-row border-accent-primary">
                                    ...
                                    <td>
                                        <a href="" class="btn primary-solid-btn">Add to Cart</a>
                                    </td>
                                </tr>
        ...
        <section class="popular-domain-list ptb-100 gray-light-bg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading text-center mb-2">
                            ...
                            <p class="lead">Assertively benchmark bricks-and-clicks opportunities and process-centric supply
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="single-popular-domain position-relative white-bg rounded shadow-sm p-5 mt-sm-4 mt-md-5 mt-lg-4">
        ...
        <section class="call-to-action ptb-100 gradient-overlay" style="background: url('assets/img/hero-bg-4.jpg')no-repeat center center / cover fixed">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading text-center mb-5">
                            ...
                            <p class="lead">Get Immediate Activation or Express Transfer service free of charge.
                                Enthusiastically enhance plug-and-play testing procedures and cross.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-12 pr-lg-0">
                        <div class="left-box white-bg">
                            ...
                            <div class="btn-holder mt-4">
                                <a class="btn primary-solid-btn" href="#">Start now</a></div>
                            <p class="mt-3">
